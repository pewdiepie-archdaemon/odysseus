...
# at module level without teardown (test_model_routes, test_endpoint_probing,
# test_vault_password_not_in_argv).  When any of those are collected before us,
# core.database is a stub and Base is a MagicMock.
